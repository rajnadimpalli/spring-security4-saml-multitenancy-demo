...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
   ...
   @Value("${saml.keystore.pass}")
   private String storePass = null;

   @Value("${saml.keystore.keyname}")
   private String storeKeyName = null;
   ...
   public WebSSOProfile webSSOprofile() {
      return new ConfigurableWebSsoProfile();
   }
   ...
   public KeyManager keyManager() {
      ...
      Resource storeFile = loader.getResource(storeLocation);
      Map<String, String> passwords = new HashMap<String, String>();
      passwords.put(storeKeyName, storePass);
      String defaultKey = storeKeyName;
   ...
   public SimpleUrlAuthenticationFailureHandler authenticationFailureHandler() {
      ...
      failureHandler.setDefaultFailureUrl("/user");
